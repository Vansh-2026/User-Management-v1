 ...
 *
 * The possible values are:
 * - `default`&mdash;Renders the standard filter UI (e.g. text, numeric, date inputs with operator pickers).
 * - `multiCheckbox`&mdash;Renders a list of distinct column values with checkboxes for inclusion/exclusion filtering.
 */
